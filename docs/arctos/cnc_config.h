...
#define N_ARC_CORRECTION 16
	 ...
	 */
        ...
        #define DEFAULT_STATUS_MASK 0 // $10
	...
	#define DEFAULT_HOMING_FAST 100
	#define DEFAULT_HOMING_SLOW 50
	#define DEFAULT_HOMING_OFFSET 10
	#define DEFAULT_STEP_PER_MM 120
	//#define DEFAULT_STEP_PER_MM_PER_AXIS {0.055555, 0.055555, 0.055555, 0.055555, 0.055555, 0.055555} // 1 mm = 10 degrees, 200 steps = 360 degrees
	// #define DEFAULT_MAX_FEED 500
	#define DEFAULT_MAX_FEED_PER_AXIS {36000, 36000, 36000, 36000, 36000, 36000} // 36000mm/min = 60deg/sec
	// #define DEFAULT_ACCEL 10
	#define DEFAULT_ACCEL_PER_AXIS {50, 50, 50, 50, 50, 50}
	// #define DEFAULT_MAX_DIST 200
	#define DEFAULT_MAX_DIST_PER_AXIS {3600, 3600, 3600, 3600, 3600, 3600} // 360 degrees max rotation on each axis.
